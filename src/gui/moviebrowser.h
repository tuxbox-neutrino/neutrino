...
{
	{ 0x00, LOCALE_GENRE_UNKNOWN,0 },
	{ 0x10, LOCALE_GENRE_MOVIE_0,0 },
	{ 0x11, LOCALE_GENRE_MOVIE_1,0 },
	{ 0x12, LOCALE_GENRE_MOVIE_2,0 },
	{ 0x13, LOCALE_GENRE_MOVIE_3,0 },
	{ 0x14, LOCALE_GENRE_MOVIE_4,0 },
	{ 0x15, LOCALE_GENRE_MOVIE_5,0 },
	{ 0x16, LOCALE_GENRE_MOVIE_6,0 },
	{ 0x17, LOCALE_GENRE_MOVIE_7,0 },
	{ 0x18, LOCALE_GENRE_MOVIE_8,0 },
	{ 0x20, LOCALE_GENRE_NEWS_0,0 },
	{ 0x21, LOCALE_GENRE_NEWS_1,0 },
	{ 0x22, LOCALE_GENRE_NEWS_2,0 },
	{ 0x23, LOCALE_GENRE_NEWS_3,0 },
	{ 0x24, LOCALE_GENRE_NEWS_4,0 },
	{ 0x30, LOCALE_GENRE_SHOW_0,0 },
	{ 0x31, LOCALE_GENRE_SHOW_1,0 },
	{ 0x32, LOCALE_GENRE_SHOW_2,0 },
	{ 0x33, LOCALE_GENRE_SHOW_3,0 },
	{ 0x40, LOCALE_GENRE_SPORTS_0,0 },
	{ 0x41, LOCALE_GENRE_SPORTS_1,0 },
	{ 0x42, LOCALE_GENRE_SPORTS_2,0 },
	{ 0x43, LOCALE_GENRE_SPORTS_3,0 },
	{ 0x44, LOCALE_GENRE_SPORTS_4,0 },
	{ 0x45, LOCALE_GENRE_SPORTS_5,0 },
	{ 0x46, LOCALE_GENRE_SPORTS_6,0 },
	{ 0x47, LOCALE_GENRE_SPORTS_7,0 },
	{ 0x48, LOCALE_GENRE_SPORTS_8,0 },
	{ 0x49, LOCALE_GENRE_SPORTS_9,0 },
	{ 0x4A, LOCALE_GENRE_SPORTS_10,0 },
	{ 0x4B, LOCALE_GENRE_SPORTS_11,0 },
	{ 0x50, LOCALE_GENRE_CHILDRENS_PROGRAMMES_0,0 },
	{ 0x51, LOCALE_GENRE_CHILDRENS_PROGRAMMES_1,0 },
	{ 0x52, LOCALE_GENRE_CHILDRENS_PROGRAMMES_2,0 },
	{ 0x53, LOCALE_GENRE_CHILDRENS_PROGRAMMES_3,0 },
	{ 0x54, LOCALE_GENRE_CHILDRENS_PROGRAMMES_4,0 },
	{ 0x55, LOCALE_GENRE_CHILDRENS_PROGRAMMES_5,0 },
	{ 0x60, LOCALE_GENRE_MUSIC_DANCE_0,0 },
	{ 0x61, LOCALE_GENRE_MUSIC_DANCE_1,0 },
	{ 0x62, LOCALE_GENRE_MUSIC_DANCE_2,0 },
	{ 0x63, LOCALE_GENRE_MUSIC_DANCE_3,0 },
	{ 0x64, LOCALE_GENRE_MUSIC_DANCE_4,0 },
	{ 0x65, LOCALE_GENRE_MUSIC_DANCE_5,0 },
	{ 0x66, LOCALE_GENRE_MUSIC_DANCE_6,0 },
	{ 0x70, LOCALE_GENRE_ARTS_0,0 },
	{ 0x71, LOCALE_GENRE_ARTS_1,0 },
	{ 0x72, LOCALE_GENRE_ARTS_2,0 },
	{ 0x73, LOCALE_GENRE_ARTS_3,0 },
	{ 0x74, LOCALE_GENRE_ARTS_4,0 },
	{ 0x75, LOCALE_GENRE_ARTS_5,0 },
	{ 0x76, LOCALE_GENRE_ARTS_6,0 },
	{ 0x77, LOCALE_GENRE_ARTS_7,0 },
	{ 0x78, LOCALE_GENRE_ARTS_8,0 },
	{ 0x79, LOCALE_GENRE_ARTS_9,0 },
	{ 0x7A, LOCALE_GENRE_ARTS_10,0 },
	{ 0x7B, LOCALE_GENRE_ARTS_11,0 },
	{ 0x80, LOCALE_GENRE_SOCIAL_POLITICAL_0,0 },
	{ 0x81, LOCALE_GENRE_SOCIAL_POLITICAL_1,0 },
	{ 0x82, LOCALE_GENRE_SOCIAL_POLITICAL_2,0 },
	{ 0x83, LOCALE_GENRE_SOCIAL_POLITICAL_3,0 },
	{ 0x90, LOCALE_GENRE_DOCUS_MAGAZINES_0,0 },
	{ 0x91, LOCALE_GENRE_DOCUS_MAGAZINES_1,0 },
	{ 0x92, LOCALE_GENRE_DOCUS_MAGAZINES_2,0 },
	{ 0x93, LOCALE_GENRE_DOCUS_MAGAZINES_3,0 },
	{ 0x94, LOCALE_GENRE_DOCUS_MAGAZINES_4,0 },
	{ 0x95, LOCALE_GENRE_DOCUS_MAGAZINES_5,0 },
	{ 0x96, LOCALE_GENRE_DOCUS_MAGAZINES_6,0 },
	{ 0x97, LOCALE_GENRE_DOCUS_MAGAZINES_7,0 },
	{ 0xA0, LOCALE_GENRE_TRAVEL_HOBBIES_0,0 },
	{ 0xA1, LOCALE_GENRE_TRAVEL_HOBBIES_1,0 },
	{ 0xA2, LOCALE_GENRE_TRAVEL_HOBBIES_2,0 },
	{ 0xA3, LOCALE_GENRE_TRAVEL_HOBBIES_3,0 },
	{ 0xA4, LOCALE_GENRE_TRAVEL_HOBBIES_4,0 },
	{ 0xA5, LOCALE_GENRE_TRAVEL_HOBBIES_5,0 },
	{ 0xA6, LOCALE_GENRE_TRAVEL_HOBBIES_6,0 },
	{ 0xA7, LOCALE_GENRE_TRAVEL_HOBBIES_7,0}
};

#define GENRE_MOVIE_COUNT 9
const CMenuOptionChooser::keyval genre_movie[GENRE_MOVIE_COUNT] =
{
	{ 0, LOCALE_GENRE_MOVIE_0,0 },
	{ 1, LOCALE_GENRE_MOVIE_1,0 },
	{ 2, LOCALE_GENRE_MOVIE_2,0 },
	{ 3, LOCALE_GENRE_MOVIE_3,0 },
	{ 4, LOCALE_GENRE_MOVIE_4,0 },
	{ 5, LOCALE_GENRE_MOVIE_5,0 },
	{ 6, LOCALE_GENRE_MOVIE_6,0 },
	{ 7, LOCALE_GENRE_MOVIE_7,0 },
	{ 8, LOCALE_GENRE_MOVIE_8,0 }
};
#define GENRE_NEWS_COUNT 5
const CMenuOptionChooser::keyval genre_news[GENRE_NEWS_COUNT] =
{
	{ 0, LOCALE_GENRE_NEWS_0,0 },
	{ 1, LOCALE_GENRE_NEWS_1,0 },
	{ 2, LOCALE_GENRE_NEWS_2,0 },
	{ 3, LOCALE_GENRE_NEWS_3,0 },
	{ 4, LOCALE_GENRE_NEWS_4,0}
};
#define GENRE_SHOW_COUNT 4
const CMenuOptionChooser::keyval genre_show[GENRE_SHOW_COUNT] =
{
	{ 0, LOCALE_GENRE_SHOW_0,0 },
	{ 1, LOCALE_GENRE_SHOW_1,0 },
	{ 2, LOCALE_GENRE_SHOW_2,0 },
	{ 3, LOCALE_GENRE_SHOW_3,0}
};
#define GENRE_SPORTS_COUNT 12
const CMenuOptionChooser::keyval genre_sports[GENRE_SPORTS_COUNT] =
{
	{ 0, LOCALE_GENRE_SPORTS_0,0 },
	{ 1, LOCALE_GENRE_SPORTS_1,0 },
	{ 2, LOCALE_GENRE_SPORTS_2,0 },
	{ 3, LOCALE_GENRE_SPORTS_3,0 },
	{ 4, LOCALE_GENRE_SPORTS_4,0 },
	{ 5, LOCALE_GENRE_SPORTS_5,0 },
	{ 6, LOCALE_GENRE_SPORTS_6,0 },
	{ 7, LOCALE_GENRE_SPORTS_7,0 },
	{ 8, LOCALE_GENRE_SPORTS_8,0 },
	{ 9, LOCALE_GENRE_SPORTS_9,0 },
	{10, LOCALE_GENRE_SPORTS_10,0 },
...
{
	{ 0, LOCALE_GENRE_CHILDRENS_PROGRAMMES_0,0 },
	{ 1, LOCALE_GENRE_CHILDRENS_PROGRAMMES_1,0 },
	{ 2, LOCALE_GENRE_CHILDRENS_PROGRAMMES_2,0 },
	{ 3, LOCALE_GENRE_CHILDRENS_PROGRAMMES_3,0 },
	{ 4, LOCALE_GENRE_CHILDRENS_PROGRAMMES_4,0 },
	{ 5, LOCALE_GENRE_CHILDRENS_PROGRAMMES_5,0}
};
#define GENRE_MUSIC_DANCE_COUNT 7
const CMenuOptionChooser::keyval genre_music_dance[GENRE_MUSIC_DANCE_COUNT] =
{
	{ 0, LOCALE_GENRE_MUSIC_DANCE_0,0 },
	{ 1, LOCALE_GENRE_MUSIC_DANCE_1,0 },
	{ 2, LOCALE_GENRE_MUSIC_DANCE_2,0 },
	{ 3, LOCALE_GENRE_MUSIC_DANCE_3,0 },
	{ 4, LOCALE_GENRE_MUSIC_DANCE_4,0 },
	{ 5, LOCALE_GENRE_MUSIC_DANCE_5,0 },
	{ 6, LOCALE_GENRE_MUSIC_DANCE_6,0}
};
#define GENRE_ARTS_COUNT 12
const CMenuOptionChooser::keyval genre_arts_dance[GENRE_ARTS_COUNT] =
{
	{ 0, LOCALE_GENRE_ARTS_0,0 },
	{ 1, LOCALE_GENRE_ARTS_1,0 },
	{ 2, LOCALE_GENRE_ARTS_2,0 },
	{ 3, LOCALE_GENRE_ARTS_3,0 },
	{ 4, LOCALE_GENRE_ARTS_4,0 },
	{ 5, LOCALE_GENRE_ARTS_5,0 },
	{ 6, LOCALE_GENRE_ARTS_6,0 },
	{ 7, LOCALE_GENRE_ARTS_7,0 },
	{ 8, LOCALE_GENRE_ARTS_8,0 },
	{ 9, LOCALE_GENRE_ARTS_9,0 },
	{10, LOCALE_GENRE_ARTS_10,0 },
	{11, LOCALE_GENRE_ARTS_11,0}
};
#define GENRE_SOCIAL_POLITICAL_COUNT 4
const CMenuOptionChooser::keyval genre_social_political[GENRE_SOCIAL_POLITICAL_COUNT] =
{
	{ 0, LOCALE_GENRE_SOCIAL_POLITICAL_0,0 },
	{ 1, LOCALE_GENRE_SOCIAL_POLITICAL_1,0 },
	{ 2, LOCALE_GENRE_SOCIAL_POLITICAL_2,0 },
	{ 3, LOCALE_GENRE_SOCIAL_POLITICAL_3,0}
};
#define GENRE_DOCUS_MAGAZINES_COUNT 8
const CMenuOptionChooser::keyval genre_docus_magazines[GENRE_DOCUS_MAGAZINES_COUNT] =
{
	{ 0, LOCALE_GENRE_DOCUS_MAGAZINES_0,0 },
	{ 1, LOCALE_GENRE_DOCUS_MAGAZINES_1,0 },
	{ 2, LOCALE_GENRE_DOCUS_MAGAZINES_2,0 },
	{ 3, LOCALE_GENRE_DOCUS_MAGAZINES_3,0 },
	{ 4, LOCALE_GENRE_DOCUS_MAGAZINES_4,0 },
	{ 5, LOCALE_GENRE_DOCUS_MAGAZINES_5,0 },
	{ 6, LOCALE_GENRE_DOCUS_MAGAZINES_6,0 },
	{ 7, LOCALE_GENRE_DOCUS_MAGAZINES_7,0}
};
#define GENRE_TRAVEL_HOBBIES_COUNT 8
const CMenuOptionChooser::keyval genre_travel_hobbies[GENRE_TRAVEL_HOBBIES_COUNT] =
{
	{ 0, LOCALE_GENRE_TRAVEL_HOBBIES_0,0 },
	{ 1, LOCALE_GENRE_TRAVEL_HOBBIES_1,0 },
	{ 2, LOCALE_GENRE_TRAVEL_HOBBIES_2,0 },
	{ 3, LOCALE_GENRE_TRAVEL_HOBBIES_3,0 },
	{ 4, LOCALE_GENRE_TRAVEL_HOBBIES_4,0 },
	{ 5, LOCALE_GENRE_TRAVEL_HOBBIES_5,0 },
	{ 6, LOCALE_GENRE_TRAVEL_HOBBIES_6,0 },
	{ 7, LOCALE_GENRE_TRAVEL_HOBBIES_7,0}
};

#define GENRE_MAJOR_COUNT 10
const CMenuOptionChooser::keyval genre_major[GENRE_MAJOR_COUNT] =
{
	{ 1, LOCALE_GENRE_MOVIE_0,0 },
	{ 2, LOCALE_GENRE_NEWS_0,0 },
	{ 3, LOCALE_GENRE_SHOW_0,0 },
	{ 4, LOCALE_GENRE_SPORTS_0,0 },
	{ 5, LOCALE_GENRE_CHILDRENS_PROGRAMMES_0,0 },
	{ 6, LOCALE_GENRE_MUSIC_DANCE_0,0 },
	{ 7, LOCALE_GENRE_ARTS_0,0 },
	{ 8, LOCALE_GENRE_SOCIAL_POLITICAL_0,0 },
	{ 9, LOCALE_GENRE_DOCUS_MAGAZINES_0,0 },
	{ 10, LOCALE_GENRE_TRAVEL_HOBBIES_0,0}
};
