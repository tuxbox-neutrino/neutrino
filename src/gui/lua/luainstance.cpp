...
static void set_lua_variables(lua_State *L)
{
	...
	{
		{ "COL_WHITE",			MAGIC_COLOR | (COL_WHITE) },
		{ "COL_BLACK",			MAGIC_COLOR | (COL_BLACK) },
		{ "COL_DARK_RED",		MAGIC_COLOR | (COL_DARK_RED) },
		{ "COL_RED",			MAGIC_COLOR | (COL_RED) },
		{ "COL_LIGHT_RED",		MAGIC_COLOR | (COL_LIGHT_RED) },
		{ "COL_DARK_GREEN",		MAGIC_COLOR | (COL_DARK_GREEN) },
		{ "COL_GREEN",			MAGIC_COLOR | (COL_GREEN) },
		{ "COL_LIGHT_GREEN",		MAGIC_COLOR | (COL_LIGHT_GREEN) },
		{ "COL_DARK_YELLOW",		MAGIC_COLOR | (COL_DARK_YELLOW) },
		{ "COL_YELLOW",			MAGIC_COLOR | (COL_YELLOW) },
		{ "COL_LIGHT_YELLOW",		MAGIC_COLOR | (COL_LIGHT_YELLOW) },
		{ "COL_DARK_BLUE",		MAGIC_COLOR | (COL_DARK_BLUE) },
		{ "COL_BLUE",			MAGIC_COLOR | (COL_BLUE) },
		{ "COL_LIGHT_BLUE",		MAGIC_COLOR | (COL_LIGHT_BLUE) },
		{ "COL_DARK_GRAY",		MAGIC_COLOR | (COL_DARK_GRAY) },
		{ "COL_GRAY",			MAGIC_COLOR | (COL_GRAY) },
		{ "COL_LIGHT_GRAY",		MAGIC_COLOR | (COL_LIGHT_GRAY) },
