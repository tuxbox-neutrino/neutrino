...
void CMovieBrowser::showMovieInfoMenu(MI_MOVIE_INFO* movie_info)
{
    ...
    CMenuWidget bookmarkMenu (LOCALE_MOVIEBROWSER_HEAD , NEUTRINO_ICON_MOVIEPLAYER_32);
    ...
    for(int li =0 ; li < MI_MOVIE_BOOK_USER_MAX && li < MAX_NUMBER_OF_BOOKMARK_ITEMS; li++ )
    {
        ...
        pBookItemMenu[li] = new CMenuWidget(LOCALE_MOVIEBROWSER_BOOK_HEAD, NEUTRINO_ICON_MOVIEPLAYER_32);
...
/**  serie******************************************************/
    ...
    CMenuWidget serieMenu (LOCALE_MOVIEBROWSER_HEAD, NEUTRINO_ICON_MOVIEPLAYER_32);
    ...
    /**  update movie info  ******************************************************/
        ...
        CMenuWidget movieInfoMenuUpdate(LOCALE_MOVIEBROWSER_HEAD, NEUTRINO_ICON_MOVIEPLAYER_32);
...
#define BUFFER_SIZE 100
    ...
    CMenuWidget movieInfoMenu(LOCALE_MOVIEBROWSER_HEAD, NEUTRINO_ICON_MOVIEPLAYER_32 /*,m_cBoxFrame.iWidth*/); //TODO: check
...
/********************************************************************/
/**  parental lock **************************************************/
    CMenuWidget parentalMenu(LOCALE_MOVIEBROWSER_HEAD, NEUTRINO_ICON_MOVIEPLAYER_32);
...
/**  optionsVerzeichnisse  **************************************************/
    CMenuWidget optionsMenuDir(LOCALE_MOVIEBROWSER_HEAD, NEUTRINO_ICON_MOVIEPLAYER_32);
...
/**  optionsMenuBrowser  **************************************************/
    ...
    CMenuWidget optionsMenuBrowser(LOCALE_MOVIEBROWSER_HEAD, NEUTRINO_ICON_MOVIEPLAYER_32);
...
/**  options  **************************************************/
    ...
    CMenuWidget optionsMenu(LOCALE_MOVIEBROWSER_HEAD, NEUTRINO_ICON_MOVIEPLAYER_32);
...
/**  main menu ******************************************************/
    ...
    CMenuWidget mainMenu(LOCALE_MOVIEBROWSER_HEAD, NEUTRINO_ICON_MOVIEPLAYER_32);
...
int CMovieBrowser::showStartPosSelectionMenu(void) // P2
{
	...
	CMenuWidgetSelection startPosSelectionMenu(LOCALE_MOVIEBROWSER_HEAD , NEUTRINO_ICON_MOVIEPLAYER_32);
...
void CDirMenu::show(void)
{
    ...
    CMenuWidget dirMenu(LOCALE_MOVIEBROWSER_HEAD, NEUTRINO_ICON_MOVIEPLAYER_32);
